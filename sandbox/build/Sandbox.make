...
ifeq ($(config),debug_x64)
  ...
  DEFINES += -DDEBUG
  INCLUDES += -Iinclude -I../../vendor/spdlog/include -I../../vendor/stb_image/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MD -MP $(DEFINES) $(INCLUDES)
  ALL_CFLAGS += $(CFLAGS) $(ALL_CPPFLAGS) -m64 -g
  ALL_CXXFLAGS += $(CXXFLAGS) $(ALL_CPPFLAGS) -m64 -g
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += -lGL -lGLEW -lglfw -lX11 -ldl -lpthread
  LDDEPS +=
...
$(OBJDIR)/RenderCommands.o: ../../engine/src/RenderCommands.cpp
	@echo $(notdir $<)
...
$(OBJDIR)/stb_image.o: ../../vendor/stb_image/stb_image.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
$(OBJDIR)/RenderTriangle.o: ../src/RenderTriangle.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF "$(@:%.o=%.d)" -c "$<"
